#Copyright 2013-2019 Dr. Syed Awase Khirni configuration with MongoDB
import logging
import os
...
class Config(object):
    def __init__(self):
        ...
        self.SERVER_NAME = 'localhost:9090'
        self.SESSION_COOKIE_NAME = 'localhost :9090'
        self.SESSION_COOKIE_DOMAIN = 'localhost :9090'

        self.SYS_ADMINS = ['awasekhirni@gmail.com']
        ...
        self.DEFAULT_MAIL_SENDER = 'Admin < awasekhirni@gmail.com >'
        self.MAIL_SERVER = 'smtp.gmail.com'
        self.MAIL_PORT = 465
        self.MAIL_USE_SSL = True
        self.MAIL_USERNAME = 'awasekhirni@gmail.com'
        self.MAIL_PASSWORD = '****************'

        # Flask-Security setup
        self.SECURITY_EMAIL_SENDER = 'Security < awasekhirni@gmail.com >'
